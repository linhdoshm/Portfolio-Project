-- 1. Commission Budget for 2022 --
    ...
    /* Assumption: Occupancy of new malls will be:
        - Vincom Mega Mall: 85%
        - Vincom Plaza: 90% 
    */
...
;
    ...
    /* Assumption:
        1) All tenants will be normal tenant ('Khách lẻ');
        2) GĐKD has Commission for all deals except for those conduct by Team 1.
    */
...
subb1_GDKD AS
    ...
    WHERE
        Tenant_type = N'Khách lẻ'
        AND position like N'Giám đốc%'),
